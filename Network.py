...
class Network(SmartClass):
    ...
    def __init__(self, num_units, tau, w_rec_sigma, w_rec_exc, w_rec_inh, w_rec_shift=1, sigmoid_gain=1,
                 sigmoid_midpoint=0.5, config=Config(), d={}):
    ...
    def plot_activities(self, t_start=0, t_end=None):
        ...
        ax.set_ylabel("Unit #")
        color_bar = plt.colorbar(mat, ax=ax)
